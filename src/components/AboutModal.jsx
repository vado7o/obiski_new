          ...
          >
            <div className="about-body">
              ...
              <div className="about-text">
                ...
                <p>
                  Это детское, чистое слово так приросло к нашему дому, что когда я решил создать приложение для малышей, сомнений не было — оно должно называться именно так.
                </p>
                <p>
                  «Абиски» — это проект, созданный с родительской любовью. Пусть и для вашего малыша английский язык станет простой, веселой и любимой игрой!
                </p>
              </div>
            </div>
